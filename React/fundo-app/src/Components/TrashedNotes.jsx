...
export default class TrashedNotes extends Component {
    ...
    handleDelete = async () => {
        controller.deleteNotePermenently(this.state.deleteId).then((res) => {
    ...
    getNotes = () => {
        ...
        controller.getTrasheNotes().then((res) => {
            this.setState({
                                    ...
                                    <div>
                                        <div className="buttons">
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <MenuItem onClick={() => this.restore()}>Restore</MenuItem>
                                                    <MenuItem onClick={() => this.handleDelete()}>Permenently Delete</MenuItem>
                                                </Menu>
